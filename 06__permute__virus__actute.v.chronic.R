...
saveRDS(MEGA.acute.v.chronic.permuted.res, "results/virus_MEGA.acute.v.chronic.permuted.res.Rds")
...
write.csv(acute.v.chronic.RESULTS, "results/virus__acute.v.chronic.Results.csv")
